...
using DotNetAuthApp.Application.Commands.Customers.Create;
using DotNetAuthApp.Application.Commands.Customers.Delete;
using DotNetAuthApp.Application.Commands.Customers.Update;
using DotNetAuthApp.Application.DTOs;
using DotNetAuthApp.Application.Queries.Customers;
using DotNetAuthApp.Core.Entities;

namespace DotNetAuthApp.API.Controllers
{
